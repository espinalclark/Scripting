...
from app.downloader import MultiThreadDownloader
from app.database import registrar_descarga, obtener_historial
from app.utils import validar_url
import os
...
def abrir_dashboard(usuario):
    ...
    def cargar_historial():
        ...
        if not historial:
            ...
            for file_name, file_url, status in historial:
                historial_box.insert(tk.END, f"{file_name} ({file_url}) - {status}")
